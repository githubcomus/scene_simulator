...
//#include "PlaceViewLaserBeamComponent.generated.h"
//
///**
// *
// */
...
//class  UPlaceViewLaserBeamComponent : public UActorComponent
//{
//    GENERATED_BODY()
//
//public:
...
//
//		// 创建网格实例
//	void CreateMeshInstance(Gamedata::EntityInfo* syncInfo, FLocalEntityInfo* localInfo);
//
//	// 销毁网格组件
//	void DestroyMeshInstance(Gamedata::EntityInfo* syncInfo, FLocalEntityInfo* localInfo);
//    void CalculateLocation(Gamedata::EntityInfo* syncInfo, FLocalEntityInfo* localInfo);
//
//    // 移动盒体碰撞
//	void UpdateMeshInstance(Gamedata::EntityInfo* syncInfo, FLocalEntityInfo* localInfo);
//
//	// 校验数据
//	bool ChectMeshInstance(Gamedata::EntityInfo* syncInfo, FLocalEntityInfo* localInfo);
//
//	// 更新网格数据
//	void RealUpdateMeshInstance(Gamedata::EntityInfo* syncInfo, FLocalEntityInfo* localInfo);
//
//	// 创建网格组件
...
//
//	// 获取指定的相对位置网格实例下标
//	bool GetMeshInstance(UHierarchicalInstancedStaticMeshComponent* meshComponent, FTransform relativeT,
//		int32& instanceIndex);
//
//	// 选中网格 创建

...
{
	// If Test2 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Test2.Build.cs is not automatically propagated
